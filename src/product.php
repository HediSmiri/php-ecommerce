                    ...
                    echo '
                                ...
                                <div id="product-main-img">
                                    <div class="product-preview">
                                        <img src="../assest/img/p_img' . $row['product_image'] . '" alt="">
                                    </div>
                                ...
                                <div id="product-imgs">
                                    ...
                                    <div class="product-preview">
                                        <img src="../assest/img/p_img' . $row['product_image'] . 'g" alt="">
                                    </div>
                    ...
                    echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									<div class='product-img'>
										<img src='../assest/img/p_img/$pro_image' style='max-height: 170px;' alt=''>

   		...
   		<div id="myCarousel" class="carousel slide" data-ride="carousel">
   			...
   			<div class="carousel-inner">
   				...
   				<div class="item active">
   					<img src="../assest/img/banner3.jpg" alt="Los Angeles" style="width:100%;">

   				</div>

   				<div class="item">
   					<img src="../assest/img/banner2.jpg" style="width:100%;">

   				</div>

   				<div class="item">
   					<img src="../assest/img/banner4.jpg" alt="New York" style="width:100%;">

   				</div>
   				<div class="item">
   					<img src="../assest/img/banner1.jpg" alt="New York" style="width:100%;">

   				</div>
   				<div class="item">
   					<img src="../assest/img/banner3.jpg" alt="New York" style="width:100%;">
   						...
   						<div id="get_product_home2">
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product01.png" alt="">
   								</div>
   								<div class="product-body">
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product02.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product03.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>
   				...
   				<div class="col-md-4 col-xs-6">
   					...
   					<div class="products-widget-slick" data-nav="#slick-nav-4">
   						<div>
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product04.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product05.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product06.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>
   						...
   						<div>
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product07.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product08.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>
   							...
   							<div class="product-widget">
   								<div class="product-img">
   									<img src="../assest/img/product09.png" alt="">
   								</div>
   								<div class="product-body">
   									<p class="product-category">Category</p>
   									<h3 class="product-name"><a href="#">product name goes here</a></h3>

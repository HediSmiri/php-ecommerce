                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <li><a href="#"><i class="fa fa-map-marker"></i>Adresse</a></li>
                            <li><a href="#"><i class="fa fa-phone"></i>+21620105711</a></li>
                            <li><a href="#"><i class="fa fa-envelope-o"></i>smirihedi4@gmail.com</a></li>
                        </ul>
                    </div>
                </div>

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assest/css/login_reg.css">
	<link rel="stylesheet" type="text/css" href="assest/css/utils.css">
...
<body style="background-color: #999999;">
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('assest/img/erik-mclean-nfoRa6NHTbU-unsplash.jpg');-webkit-transform: scaleX(-1);
  transform: scaleX(-1);"></div>
	...
	<script src="assest/js/login_reg.js"></script>
